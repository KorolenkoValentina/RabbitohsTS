...
import { GenderSelectionScreenProps, NavigationRoutes } from '../../../../components/types/NavigationTypes';



const GenderSelectionScreen: React.FC<GenderSelectionScreenProps> = ({ navigation, route }) => {

  const selectedGender: string = route.params?.selectedGender || '';

  const handleGenderSelection = (gender: string) => {
    navigation.navigate(NavigationRoutes.PROFILE, { selectedGender: gender });
  };
