...
const TeamScreen = () => {
  const sections : { title: string; data: PlayerItem[] }[] = [
  ...
  return (
    <View style={styles.container}>
      <SectionList
        ...
        renderItem={({ item }) => (
          <PlayerList data={[item]}  item={item}/>
        )}
